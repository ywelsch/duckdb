...
public:
	...
	//! The offset returned by the last FlushMarker (guarded by the WAL lock).
	idx_t GetLastFlushOffset() const {
...
protected:
	...
	//! Offset of the last flush marker (guarded by the WAL lock)
	idx_t last_flush_offset = 0;
