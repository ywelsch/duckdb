...
public:
	...
	virtual void CreateCheckpoint(optional_ptr<ClientContext> context, CheckpointOptions options = CheckpointOptions()) = 0;
...
public:
	...
	void CreateCheckpoint(optional_ptr<ClientContext> context, CheckpointOptions options) override;
