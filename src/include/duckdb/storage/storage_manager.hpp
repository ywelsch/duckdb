...
public:
	...
	//! The commit lock: every commit with changes holds it across its flush and its commit or revert, a checkpoint
	//! holds it while it starts and while it finishes, so that a commit is entirely before or after either
