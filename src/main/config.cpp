...
static const ConfigurationAlias setting_aliases[] = {
    DUCKDB_SETTING_ALIAS("memory_limit", 133),   DUCKDB_SETTING_ALIAS("null_order", 63),
    DUCKDB_SETTING_ALIAS("profile_output", 157), DUCKDB_SETTING_ALIAS("streaming_buffer_size", 134),
    DUCKDB_SETTING_ALIAS("user", 176),           DUCKDB_SETTING_ALIAS("wal_autocheckpoint", 31),
    DUCKDB_SETTING_ALIAS("worker_threads", 174), FINAL_ALIAS};
